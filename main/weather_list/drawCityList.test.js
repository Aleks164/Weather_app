...
describe("drawCityList", () => {
    ...
    it("should draw list of cities in HTML element", () => {
        ...
        const inner =
            '<ol id="olList"><li onclick="cityInList(this);" class="listItem">Ekaterinburg</li><li onclick="cityInList(this);" class="listItem">Kursk</li><li onclick="cityInList(this);" class="listItem">Penza</li><li onclick="cityInList(this);" class="listItem">Krasnodar</li></ol>';
